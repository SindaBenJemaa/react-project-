...
const VoyageCard = ({ city, desc, img, maxChars = 130 }) => {
  ...
  return (
      <div>
        <div className="rounded overflow-hidden shadow-lg ">
          <img className={`w-full object-cover object-center transition-all duration-500 ${showMore ? "max-h-64" : "max-h-28"}`} src={img} alt="img" />
          <div className="px-6 py-4">
            ...
            <p className={`text-gray-700 text-base line-clamp-3 ${showMore? 'line-clamp-3':'line-clamp-none'} `}>{desc}</p>
